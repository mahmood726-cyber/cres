        # Cres: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/cres.git

        ## Objective

        CRES (Cardio-Renal Evidence Synthesis) is a reproducible evidence-synthesis and modelling workflow tool with cardiorenal and oncology configurations, producing structured outputs with TruthCert provenance.
        ...
        - Code: https://github.com/mahmood726-cyber/cres.git
